...
class getConsole_CommandLoaderService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['console.command_loader'] = new \Symfony\Component\Console\CommandLoader\ContainerCommandLoader(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            ...
            'NeuralGlitch\\GoogleFonts\\Command\\FontsImportCommand' => ['privates', '.NeuralGlitch\\GoogleFonts\\Command\\FontsImportCommand.lazy', 'getFontsImportCommand_LazyService', true],
            'NeuralGlitch\\GoogleFonts\\Command\\FontsLockCommand' => ['privates', '.NeuralGlitch\\GoogleFonts\\Command\\FontsLockCommand.lazy', 'getFontsLockCommand_LazyService', true],
            'NeuralGlitch\\GoogleFonts\\Command\\FontsPruneCommand' => ['privates', '.NeuralGlitch\\GoogleFonts\\Command\\FontsPruneCommand.lazy', 'getFontsPruneCommand_LazyService', true],
            'NeuralGlitch\\GoogleFonts\\Command\\FontsSearchCommand' => ['privates', '.NeuralGlitch\\GoogleFonts\\Command\\FontsSearchCommand.lazy', 'getFontsSearchCommand_LazyService', true],
            'NeuralGlitch\\GoogleFonts\\Command\\FontsStatusCommand' => ['privates', '.NeuralGlitch\\GoogleFonts\\Command\\FontsStatusCommand.lazy', 'getFontsStatusCommand_LazyService', true],
            'NeuralGlitch\\GoogleFonts\\Command\\FontsWarmCacheCommand' => ['privates', '.NeuralGlitch\\GoogleFonts\\Command\\FontsWarmCacheCommand.lazy', 'getFontsWarmCacheCommand_LazyService', true],
            ...
            'doctrine.event_manager_debug_command' => 'Doctrine\\ORM\\Tools\\Console\\Command\\Debug\\DebugEventManagerDoctrineCommand',
            'doctrine.entity_listeners_debug_command' => 'Doctrine\\ORM\\Tools\\Console\\Command\\Debug\\DebugEntityListenersDoctrineCommand',
            ...
            'sass.command.build' => '?',
            'NeuralGlitch\\GoogleFonts\\Command\\FontsImportCommand' => '?',
            'NeuralGlitch\\GoogleFonts\\Command\\FontsLockCommand' => '?',
            'NeuralGlitch\\GoogleFonts\\Command\\FontsPruneCommand' => '?',
            'NeuralGlitch\\GoogleFonts\\Command\\FontsSearchCommand' => '?',
