...
/* front/actions_france/index.html.twig */
class __TwigTemplate_9983396681775f05f7c860a910434685 extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = []): iterable
    {
        ...
        $__internal_5a27a8ba21ca79b61932376b2fa922d2->enter($__internal_5a27a8ba21ca79b61932376b2fa922d2_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "front/actions_france/index.html.twig"));

        $__internal_6f47bbe9983af81f1e7450e9a3e3768f = $this->extensions["Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension"];
        $__internal_6f47bbe9983af81f1e7450e9a3e3768f->enter($__internal_6f47bbe9983af81f1e7450e9a3e3768f_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "front/actions_france/index.html.twig"));
    ...
    public function block_body(array $context, array $blocks = []): iterable
    {
      ...
      <div class=\"banner-container\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["action"]) {
            // line 25
            yield "                    <div ";
            yield (((($tmp = CoreExtension::getAttribute($this->env, $this->source, $context["action"], "getHtmlId", [], "any", false, false, false, 25)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ("id=") : (""));
            yield "\"";
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["action"], "getHtmlId", [], "any", false, false, false, 25), "html", null, true);
            yield "\" class=\"actions__item subsection\">
                        ";
            // line 26
            if ((($tmp =  !Twig\Extension\CoreExtension::testEmpty(CoreExtension::getAttribute($this->env, $this->source, $context["action"], "title", [], "any", false, false, false, 26))) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                // line 27
                yield "                            <h3  class=\"actions__title ";
                yield (((($tmp = ((CoreExtension::getAttribute($this->env, $this->source, $context["action"], "aside", [], "any", true, true, false, 27)) ? (Twig\Extension\CoreExtension::default(CoreExtension::getAttribute($this->env, $this->source, $context["action"], "aside", [], "any", false, false, false, 27))) : (""))) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ("subsection__title-grid") : (""));
                yield "\">
                                ";
                // line 28
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["action"], "title", [], "any", false, false, false, 28), "html", null, true);
                yield "
                            </h3>
                        ";
            }
            ...
            yield "                        <div>
                        ";
            // line 32
            yield CoreExtension::getAttribute($this->env, $this->source, $context["action"], "text", [], "any", false, false, false, 32);
            yield "
                        </div>
                        ";
            // line 34
            if ((($tmp =  !Twig\Extension\CoreExtension::testEmpty(CoreExtension::getAttribute($this->env, $this->source, $context["action"], "aside", [], "any", false, false, false, 34))) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                // line 35
                yield "                            <aside class=\"subsection__quote ";
                yield (((($tmp = CoreExtension::getAttribute($this->env, $this->source, $context["action"], "left", [], "any", false, false, false, 35)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ("left") : (""));
                yield "\">
                                ...
                                <blockquote>\"";
                // line 37
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["action"], "aside", [], "any", false, false, false, 37), "html", null, true);
                yield "\"</blockquote>
                            </aside>
                        ";
            }
        ...
        // line 90
        $context['_parent'] = $context;
        $context['_seq'] = CoreExtension::ensureTraversable((isset($context["franceSections"]) || array_key_exists("franceSections", $context) ? $context["franceSections"] : (function () { throw new RuntimeError('Variable "franceSections" does not exist.', 90, $this->source); })()));
        foreach ($context['_seq'] as $context["_key"] => $context["franceSection"]) {
            // line 91
            yield "                    <section class=\"subsection\">
                        ";
            // line 92
            if ((($tmp =  !Twig\Extension\CoreExtension::testEmpty(CoreExtension::getAttribute($this->env, $this->source, $context["franceSection"], "title", [], "any", false, false, false, 92))) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                // line 93
                yield "                            <h2
                                class=\"subsection__title ";
                // line 94
                yield (((($tmp = ((CoreExtension::getAttribute($this->env, $this->source, $context["franceSection"], "aside", [], "any", true, true, false, 94)) ? (Twig\Extension\CoreExtension::default(CoreExtension::getAttribute($this->env, $this->source, $context["franceSection"], "aside", [], "any", false, false, false, 94))) : (""))) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ("subsection__title-grid") : (""));
                yield "\">
                                ";
                // line 95
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["franceSection"], "title", [], "any", false, false, false, 95), "html", null, true);
                yield "
                            </h2>
                        ";
            }
            ...
            yield "                        <div>
                        ";
            // line 99
            yield CoreExtension::getAttribute($this->env, $this->source, $context["franceSection"], "text", [], "any", false, false, false, 99);
            yield "
                        </div>
                        ";
            // line 101
            if ((($tmp =  !Twig\Extension\CoreExtension::testEmpty(CoreExtension::getAttribute($this->env, $this->source, $context["franceSection"], "aside", [], "any", false, false, false, 101))) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                // line 102
                yield "                            <aside class=\"subsection__quote ";
                yield (((($tmp = CoreExtension::getAttribute($this->env, $this->source, $context["franceSection"], "left", [], "any", false, false, false, 102)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ("left") : (""));
                yield "\">
                                <svg xmlns=\"http://www.w3.org/2000/svg\" height=\"24px\" viewbox=\"0 -960 960 960\" width=\"24px\" fill=\"currentColor\"><path d=\"m354-287 126-76 126 77-33-144 111-96-146-13-58-136-58 135-146 13 111 97-33 143ZM233-120l65-281L80-590l288-25 112-265 112 265 288 25-218 189 65 281-247-149-247 149Zm457-560 21-89-71-59 94-8 36-84 36 84 94 8-71 59 21 89-80-47-80 47ZM480-481Z\"/></svg>
                                <blockquote>\"";
                // line 104
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["franceSection"], "aside", [], "any", false, false, false, 104), "html", null, true);
                yield "\"</blockquote>
                            </aside>
                        ";
            }
...
";
    ...
    {
        return "front/actions_france/index.html.twig";
    }
    ...
    {
        return array (  248 => 131,  245 => 109,  238 => 107,  232 => 104,  226 => 102,  224 => 101,  219 => 99,  216 => 98,  210 => 95,  206 => 94,  203 => 93,  201 => 92,  198 => 91,  194 => 90,  190 => 88,  188 => 43,  180 => 40,  174 => 37,  168 => 35,  166 => 34,  161 => 32,  158 => 31,  152 => 28,  147 => 27,  145 => 26,  138 => 25,  134 => 24,  122 => 16,  114 => 14,  112 => 13,  108 => 12,  100 => 6,  87 => 5,  64 => 3,  41 => 1,);
    }
...
{% endblock %}
", "front/actions_france/index.html.twig", "/var/www/html/Benevolat/TAM/tam-symfo/templates/front/actions_france/index.html.twig");
    }
}
