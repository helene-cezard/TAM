...
/* back/main/index.html.twig */
class __TwigTemplate_2581e041730e3abb958990351c6e9184 extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = []): iterable
    {
        ...
        $__internal_5a27a8ba21ca79b61932376b2fa922d2->enter($__internal_5a27a8ba21ca79b61932376b2fa922d2_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "back/main/index.html.twig"));

        $__internal_6f47bbe9983af81f1e7450e9a3e3768f = $this->extensions["Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension"];
        $__internal_6f47bbe9983af81f1e7450e9a3e3768f->enter($__internal_6f47bbe9983af81f1e7450e9a3e3768f_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "back/main/index.html.twig"));
    ...
    public function block_body(array $context, array $blocks = []): iterable
    {
        ...
        $context['_seq'] = CoreExtension::ensureTraversable((isset($context["carouselImages"]) || array_key_exists("carouselImages", $context) ? $context["carouselImages"] : (function () { throw new RuntimeError('Variable "carouselImages" does not exist.', 20, $this->source); })()));
        foreach ($context['_seq'] as $context["_key"] => $context["carouselImage"]) {
            // line 21
            yield "                        <div class=\"carousel__gallery__card\">
                            <img src=\"";
            // line 22
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, $context["carouselImage"], "getGalleryId", [], "any", false, false, false, 22), "path", [], "any", false, false, false, 22), "html", null, true);
            yield "\" alt=\"";
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, $context["carouselImage"], "getGalleryId", [], "any", false, false, false, 22), "alt", [], "any", false, false, false, 22), "html", null, true);
            yield "\">
                            <div class=\"carousel__gallery__text\">
                                <p>";
            // line 24
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, $context["carouselImage"], "getGalleryId", [], "any", false, false, false, 24), "alt", [], "any", false, false, false, 24), "html", null, true);
            yield "</p>
                            </div>
                        </div>
                    ";
        ...
        // line 34
        $context['_parent'] = $context;
        $context['_seq'] = CoreExtension::ensureTraversable((isset($context["homeSections"]) || array_key_exists("homeSections", $context) ? $context["homeSections"] : (function () { throw new RuntimeError('Variable "homeSections" does not exist.', 34, $this->source); })()));
        foreach ($context['_seq'] as $context["_key"] => $context["homeSection"]) {
            // line 35
            yield "                    <section class=\"subsection subsection-border\">
                        <button class=\"position-button up\">&uarr;</button>
                        <button class=\"position-button down\">&darr;</button>
                        ";
            // line 38
            if ((($tmp =  !Twig\Extension\CoreExtension::testEmpty(CoreExtension::getAttribute($this->env, $this->source, $context["homeSection"], "title", [], "any", false, false, false, 38))) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                // line 39
                yield "                            <h2
                                class=\"subsection__title ";
                // line 40
                yield (((($tmp = ((CoreExtension::getAttribute($this->env, $this->source, $context["homeSection"], "aside", [], "any", true, true, false, 40)) ? (Twig\Extension\CoreExtension::default(CoreExtension::getAttribute($this->env, $this->source, $context["homeSection"], "aside", [], "any", false, false, false, 40))) : (""))) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ("subsection__title-grid") : (""));
                yield "\">
                                ";
                // line 41
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["homeSection"], "title", [], "any", false, false, false, 41), "html", null, true);
                yield "
                            </h2>
                        ";
            }
            ...
            yield "                        <div>
                        ";
            // line 45
            yield CoreExtension::getAttribute($this->env, $this->source, $context["homeSection"], "text", [], "any", false, false, false, 45);
            yield "
                        </div>
                        ";
            // line 47
            if ((($tmp =  !Twig\Extension\CoreExtension::testEmpty(CoreExtension::getAttribute($this->env, $this->source, $context["homeSection"], "aside", [], "any", false, false, false, 47))) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                // line 48
                yield "                            <aside class=\"subsection__quote ";
                yield (((($tmp = CoreExtension::getAttribute($this->env, $this->source, $context["homeSection"], "leftSide", [], "any", false, false, false, 48)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ("left") : (""));
                yield "\">
                                ...
                                <blockquote>\"";
                // line 50
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["homeSection"], "aside", [], "any", false, false, false, 50), "html", null, true);
                yield "\"</blockquote>
                            </aside>
                        ";
            }
        ...
        yield "
                    <section class=\"form\">";
        // line 57
        yield         $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderBlock((isset($context["sectionForm"]) || array_key_exists("sectionForm", $context) ? $context["sectionForm"] : (function () { throw new RuntimeError('Variable "sectionForm" does not exist.', 57, $this->source); })()), 'form');
        yield "</section>
...
";
    ...
    {
        return "back/main/index.html.twig";
    }
    ...
    {
        return array (  256 => 93,  245 => 85,  231 => 74,  222 => 68,  213 => 62,  205 => 57,  202 => 56,  194 => 53,  188 => 50,  182 => 48,  180 => 47,  175 => 45,  172 => 44,  166 => 41,  162 => 40,  159 => 39,  157 => 38,  152 => 35,  148 => 34,  140 => 28,  130 => 24,  123 => 22,  120 => 21,  116 => 20,  100 => 6,  87 => 5,  64 => 3,  41 => 1,);
    }
        ...
        <div class=\"banner-container\">
            ...
            <div class=\"banner__pusher\">
                <section class=\"home section\">
                    ...
                    <section class=\"subsection subsection-border\">
                        <button class=\"position-button up\">&uarr;</button>
                        <button class=\"position-button down\">&darr;</button>
                        {% if homeSection.title is not empty %}
                            <h2
                                class=\"subsection__title {{ homeSection.aside|default ? 'subsection__title-grid' : '' }}\">
                                {{ homeSection.title }}
                            </h2>
                        {% endif %}
                        <div>
                    ...
                    <section class=\"form\">{{ form(sectionForm) }}</section>
                    <section class=\"home__pilars\">
                        <h2 class=\"section__title\">Trois piliers</h2>
                        <ul class=\"home__pilars__list\">
                            <li class=\"home__pilars__card\">
...
{% endblock %}
", "back/main/index.html.twig", "/var/www/html/Benevolat/TAM/tam-symfo/templates/back/main/index.html.twig");
    }
}
